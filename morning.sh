...
menuentry "Linux From Scratch" {
    set gfxpayload=text
    linux /boot/__KERNEL__ root=UUID=__ROOT_UUID__ rw rootfstype=ext4 rootwait nomodeset console=tty0
__INITRD_LINE__
}

menuentry "Linux From Scratch (verbose boot)" {
    set gfxpayload=text
    linux /boot/__KERNEL__ root=UUID=__ROOT_UUID__ rw rootfstype=ext4 rootwait nomodeset console=tty0 loglevel=7 ignore_loglevel
__INITRD_LINE__
}

menuentry "Linux From Scratch (EFI framebuffer)" {
    set gfxpayload=keep
    linux /boot/__KERNEL__ root=UUID=__ROOT_UUID__ rw rootfstype=ext4 rootwait console=tty0 video=efifb:on
__INITRD_LINE__
}
CFGEOF
